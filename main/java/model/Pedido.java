...
public class Pedido implements Serializable {
    ...
    public double calcularValorRecebido() {
        double desconto = 0.0;
        double valorComTaxa = getValorComTaxa(); // Corrigido para usar o valor com taxa
        ...
        switch (metodoPagamento) {
            case "Dinheiro":
                ...
                break;
            case "Pix":
                desconto = Math.min(valorComTaxa * 0.0145, 10.0);
                break;
            case "Débito":
                desconto = valorComTaxa * 0.014;
                break;
            case "Crédito":
                desconto = valorComTaxa * 0.031;
                break;
        }

        return valorComTaxa - desconto; // Corrigido para usar o valor com taxa
    }
    ...
    public String gerarRelatorioItens() {
        StringBuilder relatorio = new StringBuilder("Itens do Pedido:\n");
        for (String item : itens) {
            relatorio.append(item).append("\n");
        }
        relatorio.append("Valor total: R$").append(getValorTotalFormatado()).append("\n");
        relatorio.append("Valor com taxa: R$").append(getValorComTaxaFormatado()).append("\n");
